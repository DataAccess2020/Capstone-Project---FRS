...
Rcrawler (Website = "https://www.repubblica.it", #LINK DEL SITO DI PARTENZA
          ...
          Obeyrobots = FALSE, #AUTOMSTIC CONTROL AND RESPECT ROBOTS.TXT
          ...
          ExtractCSSPat = ".middle-img h1 , .summary , .body-text > span", #SEGUI SOLO LINK CON QUESTO CSS PATTERN
          )

#inspect csv file
extracted_data <- read_csv("data/repubblica.it-141352/extracted_data.csv")
View(extracted_data)


list_DATA<-LoadHTMLFiles("data/repubblica.it-141605", type = "vector")
list_DATA
