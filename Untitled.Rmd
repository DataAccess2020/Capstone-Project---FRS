...
This dataset was obtained in two steps: the first step is what we call vectorization: using the command unnest_token I divided the entire articles in single words. This way, I obtained a dataset with 18920 observations. The second step is about the pre-processing: I removed from the observations what was unusful for the analysis. This way I obtained dat3. This dataset can be opened going to the folder data and then opening the file *IlCorriereDellaSera.Rdata*.
