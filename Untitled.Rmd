...
The saved dataset are: 
 - dat: it is the starting dataset, created after the scraping part of my analysis. It is composed by:
                  ...
                  - 3 variables: link, articlestext, section 
                
his dataset can be opened going to the folder data and then opening the file Corrierearticles1702.Rdata.
...
The first step is what we call vectorization: using the command unnest_token I divided the entire articles in single words. This way, I obtained a dataset with 18920 observations;
The second step is about the pre-processing: I removed from the observations what was unusful for the analysis. This way I obtained dat3;
...
00_setup: it is the script containing all the used packages and the library of them;
01_scraping: it is the script which contains the scraping part;
02_textanalysis: it is the script that contains
the part of tokenization and pre-processing;
the part about word frequencies
03_sentiment: it is the script containg the sentiment analysis.
JUNK
